	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : SV_Target
			{
				...
				float border_self_h=tex2D (_HeightTex,float2(1.0f,newUV.y));
				float border_neighbor_h=tex2D (_NeighborHeightTex,float2(0.0f,newUV.y));
